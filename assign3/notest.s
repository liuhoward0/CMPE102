...
#   copy 10 spaces to itoa_string
    ...
    movl   $0x20202020,itoa_string+8
    movl   $0x20202020,itoa_string+12
    movl   $0x20202020,itoa_string+16
    movl   $0x20202020,itoa_string+20
    movl   $0x20202020,itoa_string+24
    movl   $0x20202020,itoa_string+28
    movw   $0x2020,itoa_string+32
#   point %edi index register to the last byte of itoa_string, think:
#   char *itoa_string="    ";
#   char *edi = &itoa_string[9];
    lea    itoa_string+31,%edi
itoa_loop:
    mov    $0,%edx
    idivl  ten
